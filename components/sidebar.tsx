...
function SidebarProvider({
  ...
  // We use openProp and setOpenProp for the controlled state.
...
function SidebarInput({
  ...
  ref,
  ...props
}: ComponentProps<typeof Input> & { ref?: React.Ref<HTMLInputElement> }) {
  return (
    <Input
      ref={ref}
      data-sidebar="input"
...
function SidebarSeparator({
  ...
  ref,
  ...props
}: ComponentProps<typeof Separator> & { ref?: React.Ref<HTMLDivElement> }) {
  return (
    <Separator
      ref={ref}
...
function SidebarMenu({
  ...
  ref,
  ...props
}: HTMLAttributes<HTMLUListElement> & { ref?: React.Ref<HTMLUListElement> }) {
  return (
    <ul
      ref={ref}
      data-sidebar="menu"
